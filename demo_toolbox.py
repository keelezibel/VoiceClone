...
if __name__ == '__main__':
    ...
    parser.add_argument("--input_wav", default="./Data/Lin Zhi Ling/", help=\
        "Input wav file directory to adapt the model")
    parser.add_argument("--output_dir", default="./Data/Synth/Lin.wav", help=\
        "Output directory for the synthesized voice")
