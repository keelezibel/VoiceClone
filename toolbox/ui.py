...
class UI(QDialog):
    ...
    def record_one(self, sample_rate, duration,ind,input_dir):
        self.record_button.setText("Importing...")
        ...
        # Take from folder
        input_path = os.path.join(input_dir,"in{}.wav".format(ind))
        try:
            wav, fs = sf.read(input_path)
        except Exception as e:
            print(e)
            self.log("Could not load file.")
            return None

        self.log("Done importing.")
        self.record_button.setText("Import")
